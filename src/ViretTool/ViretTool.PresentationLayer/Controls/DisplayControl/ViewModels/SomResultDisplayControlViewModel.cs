...
{
    public class SomResultDisplayControlViewModel : DisplayControlViewModelBase
    {
        private bool _isLargeFramesChecked;
        private FrameViewModel _gpsFrame;

        private ISomGeneratorProvider _somGeneratorProvider;
            ...
            : base(logger, datasetServicesManager, iterationLogger)
        {
            ...
            {
                _somGeneratorProvider = datasetServicesManager.CurrentDataset.SomGeneratorProvider;
                LoadInitialDisplay();
            };
        }
