...
namespace ViretTool.BusinessLayer.TextSearch
{
    /// <summary>
    ...
    public class AhoCorasick
    {
        ...
        private readonly CaseSensitive CaseSensitivity = CaseSensitive.No;
        ...
        public void Build()
        {
            ...
            while (queue.Count > 0)
            {
                ...
                foreach (var child in node)
                {
                    ...
                    if (fallBack.Hit != null)
                    {
                        child.Jump = fallBack;
                    }
                    else
                    {
                        child.Jump = fallBack.Jump;
                    }
