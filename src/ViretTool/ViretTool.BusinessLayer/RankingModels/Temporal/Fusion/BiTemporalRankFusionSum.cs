...
{
    public class BiTemporalRankFusionSum : IBiTemporalRankFusion
    {
            ...
            BiTemporalRankingBuffer outputRanking)
        {
            ...
            ComputeSingleRankingForward(PrimaryInputRanking, SecondaryInputRanking,
                OutputRanking.PrimaryRankingBuffer, OutputRanking.PrimaryPairs);

            ComputeSingleRankingBackward(SecondaryInputRanking, PrimaryInputRanking,
                OutputRanking.SecondaryRankingBuffer, OutputRanking.SecondaryPairs);
        }
